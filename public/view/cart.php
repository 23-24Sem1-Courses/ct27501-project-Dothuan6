...
<div class="container-fluid">
                     ...
                     while($row_product_price=$stmt->fetch()){
                       ...
                       $sub_price = number_format(($total_price_format + $vat),3);
                        ...
                        <tr class='text-center'>
                            ...
                            <td><?php echo "<img class='cart_img center-block' src='./../admin/view/product_images/$product_image1'"?>
                            </td>
    ...
    ?>
        ...
        if($result_count>0){
            ...
            <button class='mx-2 bg-secondary py-2 px-3 border-0 btn btn-outline'> <a href='checkout.php?user_id=$user_id' class='text-light' style='text-decoration: none;'>Thanh toán</a></button>
            </div></div>";
        }
      else{
        ...
        if($result_count>0){
             ...
             USD</strong></h7>
                ...
                bg-warning btn btn-outline' name='continue_shopping'> <a
                        href='index.php' class='text-dark' style='text-decoration: none;'>Mua sắm</a></button>
                <button class='mx-2 bg-secondary py-2 px-3 border-0 btn btn-outline'> <a href='checkout.php'
