    ...
    if(isset($_POST['insert_product'])){
      ...
      if($row_products==0){
        ...
        empty($product_image1)){
            ...
            move_uploaded_file($temp_image1,"./../view/product_images/$product_image1");
            //insert query
...
global $conn;
    if(isset($_GET['delete_category'])){
        ...
        if($result_delete_category){
            ...
            echo "<script>window.open('index.php?action=insert_categories','_self')</script>";
        }
    }
}
...
if(isset($_GET['delete_products'])){
    ...
    if($result_product){
        echo "<script>alert('Xóa thành công!')</script>";
        echo "<script>window.open('index.php?action=insert_products','_self')</script>";
    }
} 
}
