...
function getProductsGLC(){
    ...
    while($row = $stmt->fetch()){
      ...
      <div class='card border-0' style='width: 19rem;'>
          <a href='product_details.php?product_id=$product_id'><img src='./../admin/view/product_images/$product_image1' class='card-img-top btn img' alt=''></a>
...
function view_details(){
  ...
  <div class='row py-4 w-75 m-auto'>
      <div class='col-md-4 col-sm-12 col-lg-4'>
        <img src='./../admin/view/product_images/$product_image1' class='d-block' style='width:100%;' alt='...'>
      </div>
